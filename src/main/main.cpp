...
setup() {
  ...
  Wire.setPins(ESP32Pin::i2c_sda, ESP32Pin::i2c_scl); // Set I2C driver pins
  Serial::setLogLevelMax(SerialParameter::log_level_max); // Set serial object maximum log level.
  ...
  serial_number_ = EEPROM.readByte(AddressParameter::eeprom_serial_number);
  ...
  xTaskCreatePinnedToCore(ioExpanderAInterruptServiceTask,
                          "task_handle_io_expander_a_interrupt_service_",
                          TaskParameter::stack_size,
                          nullptr,
                          TaskParameter::priority_max,
                          &task_handle_io_expander_a_interrupt_service_,
                          TaskParameter::core_1);
  xTaskCreatePinnedToCore(ioExpanderBInterruptServiceTask,
                          "task_handle_io_expander_b_interrupt_service_",
                          TaskParameter::stack_size,
                          nullptr,
                          TaskParameter::priority_max,
                          &task_handle_io_expander_b_interrupt_service_,
  ...
  xTaskCreatePinnedToCore(realTimeTask,
                          ...
                          &task_handle_real_time_,
                          TaskParameter::core_1);
  xTaskCreatePinnedToCore(udpReadBipedMessageTask,
                          "task_handle_udp_read_biped_message_",
                          TaskParameter::stack_size,
                          nullptr,
                          TaskParameter::priority_min,
                          &task_handle_udp_read_biped_message_,
                          TaskParameter::core_1);
  xTaskCreatePinnedToCore(udpWriteBipedMessageTask,
                          "task_handle_udp_write_biped_message_",
                          TaskParameter::stack_size,
                          nullptr,
                          TaskParameter::priority_min,
                          &task_handle_udp_write_biped_message_,
                          TaskParameter::core_1);
  xTaskCreatePinnedToCore(udpWriteCameraTask,
                          "task_handle_udp_write_camera_",
                          TaskParameter::stack_size,
                          nullptr,
                          TaskParameter::priority_min,
                          &task_handle_udp_write_camera_,
