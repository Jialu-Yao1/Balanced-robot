...
PIDController::control() {
  ...
  double error = clamp(state_ - reference_, saturation_.input_lower, saturation_.input_upper);
  ...
  error_integral_ = clamp(error_integral_, -gain_.integral_max, gain_.integral_max);
  ...
  double p_out = gain_.proportional * error;
  ...
  double i_out = gain_.integral * error_integral_;
  ...
  double d_out = gain_.differential * error_differential_;
  ...
  return clamp(sum, saturation_.output_lower, saturation_.output_upper);
}
}   // namespace firmware
}   // namespace biped
