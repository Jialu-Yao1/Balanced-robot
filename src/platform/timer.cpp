 ...
 */
namespace firmware {
Timer::Timer(const timer_group_t &group, const timer_idx_t &index) : group_(group),
                                                                     index_(index),
                                                                     interrupt_handle_(nullptr),
                                                                     interrupt_source_(-1),
                                                                     register_config_(nullptr),
                                                                     register_alarm_low_(nullptr),
                                                                     register_alarm_high_(nullptr),
                                                                     register_counter_low_(nullptr),
                                                                     register_counter_high_(nullptr),
                                                                     register_interrupt_clear_(nullptr),
                                                                     register_interrupt_enable_(nullptr),
                                                                     register_load_low_(nullptr),
  ...
  register_interrupt_clear_ = reinterpret_cast<uint32_t *>(TIMG_INT_CLR_TIMERS_REG(group));
  register_interrupt_enable_ = reinterpret_cast<uint32_t *>(TIMG_INT_ENA_TIMERS_REG(group));
  ...
  switch (index_) {
    case TIMER_0: {
      ...
      register_config_ = reinterpret_cast<uint32_t *>(TIMG_T0CONFIG_REG(group));
      register_alarm_low_ = reinterpret_cast<uint32_t *>(TIMG_T0ALARMLO_REG(group));
      register_alarm_high_ = reinterpret_cast<uint32_t *>(TIMG_T0ALARMHI_REG(group));
      register_counter_low_ = reinterpret_cast<uint32_t *>(TIMG_T0LO_REG(group));
      register_counter_high_ = reinterpret_cast<uint32_t *>(TIMG_T0HI_REG(group));
      register_load_low_ = reinterpret_cast<uint32_t *>(TIMG_T0LOADLO_REG(group));
      register_load_high_ = reinterpret_cast<uint32_t *>(TIMG_T0LOADHI_REG(group));
      ...
      uint32_t framed_bits = (static_cast<uint32_t>(TimerParameter::prescaler) << TIMG_T0_DIVIDER_S) & TIMG_T0_DIVIDER_M;
      ...
      *register_config_ = 0; // clear the timer configuration register by zeroing all its bits
      *register_config_ |= (TIMG_T0_INCREASE | TIMG_T0_AUTORELOAD | TIMG_T0_LEVEL_INT_EN | TIMG_T0_ALARM_EN | framed_bits);
    ...
    case TIMER_1: {
      ...
      register_config_ = reinterpret_cast<uint32_t *>(TIMG_T1CONFIG_REG(group));
      register_alarm_low_ = reinterpret_cast<uint32_t *>(TIMG_T1ALARMLO_REG(group));
      register_alarm_high_ = reinterpret_cast<uint32_t *>(TIMG_T1ALARMHI_REG(group));
      register_counter_low_ = reinterpret_cast<uint32_t *>(TIMG_T1LO_REG(group));
      register_counter_high_ = reinterpret_cast<uint32_t *>(TIMG_T1HI_REG(group));
      register_load_low_ = reinterpret_cast<uint32_t *>(TIMG_T1LOADLO_REG(group));
      register_load_high_ = reinterpret_cast<uint32_t *>(TIMG_T1LOADHI_REG(group));
      ...
      uint32_t framed_bits = (static_cast<uint32_t>(TimerParameter::prescaler) << TIMG_T1_DIVIDER_S) & TIMG_T1_DIVIDER_M;
      ...
      *register_config_ = 0; // clear the timer configuration register by zeroing all its bits
      *register_config_ |= (TIMG_T1_INCREASE | TIMG_T1_AUTORELOAD | TIMG_T1_LEVEL_INT_EN | TIMG_T1_ALARM_EN | framed_bits);
...
bool
Timer::attachInterrupt(void (*handler)(void *), void *arg) {
  /*
  ...
  if (esp_intr_alloc(interrupt_source_, 0, handler, arg, &interrupt_handle_) != ESP_OK) {
    return false;
  }
  ...
  if (esp_intr_enable(interrupt_handle_) != ESP_OK) {
    return false;
  }
...
Timer::setInterval(const uint64_t &interval) {
  ...
  *register_alarm_low_ = static_cast<uint32_t>(interval);
  *register_alarm_high_ = static_cast<uint32_t>(interval >> 32);
}
}   // namespace firmware
}   // namespace biped
